...
/*
int Bsplit_Bstep::execute( const int & tag, B_context & Bctxt ) const {
    ...
    if(tag == 0) {
        ...
        Bctxt.m_BDitem.put(0,1);
        Bctxt.m_BDtags.put(0);
    }
        ...
        //func_B(x+mij, u+mij , v+mij, n, R);
        //func_B(x+mi, u+mij , v+mi, n, R);
...
int BD_Bstep::execute( const int & tag, B_context & Bctxt ) const {

    int a,b;
    if(tag ==0) {
        Bctxt.m_BDitem.get(0,a);
        Bctxt.m_BDitem.get(1,b);
        if(a==1 && b==1) {
            Bctxt.m_BDitem.put(0,0);
            Bctxt.m_BDitem.put(1,0);
            Bctxt.m_Dtags.put(0);
            Bctxt.m_Dtags.put(1);
        }
    }
        ...
        if(a==1 && b==1) {
            Bctxt.m_BDitem.put(0,0);
            Bctxt.m_BDitem.put(1,0);
            Bctxt.m_splitBtags.put(2);
            Bctxt.m_splitBtags.put(3);
        }
    }
    else if(tag == 2){
        Bctxt.m_BDitem.get(0,a);
...
int D_Bstep::execute( const int & tag, B_context & Bctxt ) const {
...
struct C_context : public CnC::context< C_context >
{
    ...
    CnC::item_collection< int, int >  m_DC1syncitem;
    CnC::item_collection< int, int >  m_CD2syncitem;
    CnC::item_collection< int, int >  m_DC2syncitem;
    //CnC::item_collection< int, int >  m_Ditem;
              ...
              m_D4tags( *this )
    {
        ...
        m_C3steps.produces( m_CD2syncitem );
        m_C4steps.produces( m_CD2syncitem );
        m_D3steps.produces( m_DC2syncitem );
        m_D4steps.produces( m_DC2syncitem );
...
int C_Cstep::execute( const int & tag, C_context & Cctxt ) const {
    ...
    if(tag==0) {
        if (size <= B) {
            ...
            Cctxt.m_splitCtags.put(0);
            Cctxt.m_splitCtags.put(1);
            Cctxt.m_CDitem.put(0,0);
            Cctxt.m_CDitem.put(1,0);
        }

    }
}

int Csplit_Cstep::execute( const int & tag, C_context & Cctxt ) const {
    ...
    if(tag == 0) {
        ...
        Cctxt.m_CDitem.put(0,1);
        Cctxt.m_CDtags.put(0);
    }
...
int CD_Cstep::execute( const int & tag, C_context & Cctxt ) const {

    int a,b;
    if(tag ==0) {
        Cctxt.m_CDitem.get(0,a);
        Cctxt.m_CDitem.get(1,b);
        if(a==1 && b==1) {
            Cctxt.m_CDitem.put(0,0);
            Cctxt.m_CDitem.put(1,0);
            Cctxt.m_Dtags.put(0);
        ...
        if(a==1 && b==1) {
            Cctxt.m_CDitem.put(0,0);
            Cctxt.m_CDitem.put(1,0);
            Cctxt.m_splitCtags.put(2);
            Cctxt.m_splitCtags.put(3);
        }
    }
    else if(tag == 2){
        Cctxt.m_CDitem.get(0,a);
...
int D_Cstep::execute( const int & tag, C_context & Cctxt ) const {
...
int D_Dstep::execute( const int & tag, D_context & Dctxt ) const {
    ...
    if(tag==0) {
        if (size <= B) {
            ...
            Dctxt.m_splitCtags.put(0);
            Dctxt.m_splitCtags.put(1);
            Dctxt.m_splitCtags.put(0);
            Dctxt.m_splitCtags.put(1);
            Dctxt.m_CDitem.put(0,0);
            Dctxt.m_CDitem.put(1,0);
            Dctxt.m_CDitem.put(2,0);
            Dctxt.m_CDitem.put(3,0);
        }

    }
}

int D_Dstep::execute( const int & tag, C_context & Cctxt ) const {
    ...
    if(tag == 0) {
        ...
        Dctxt.m_DDitem.put(0,1);
        Dctxt.m_DDtags.put(0);
    }
...
int DD_Dstep::execute( const int & tag, D_context & Dctxt ) const {

    int a,b,c,d;
    if(tag ==0) {
        Dctxt.m_DDitem.get(0,a);
        Dctxt.m_DDitem.get(1,b);
        Dctxt.m_DDitem.get(2,c);
        Dctxt.m_DDitem.get(3,d);
        if(a==1 && b==1 && c==1 && d==1) {
            Dctxt.m_Dtags.put(4);
            Dctxt.m_Dtags.put(5);
            Dctxt.m_Dtags.put(6);
